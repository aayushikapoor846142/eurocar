                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('vehicle_example') is-invalid @enderror" 
                               id="vehicle_example" name="vehicle_example" value="{{ old('vehicle_example') }}"
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('max_passengers') is-invalid @enderror" 
                               id="max_passengers" name="max_passengers" value="{{ old('max_passengers') }}" 
                               min="1" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('max_big_bags') is-invalid @enderror" 
                               id="max_big_bags" name="max_big_bags" value="{{ old('max_big_bags') }}" 
                               min="0" required>
                        @error('max_big_bags')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('max_small_bags') is-invalid @enderror" 
                               id="max_small_bags" name="max_small_bags" value="{{ old('max_small_bags') }}" 
                               min="0" required>
